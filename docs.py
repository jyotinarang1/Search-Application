...
# 'accessor' convenience methods
  ...
  def _buildCoreProductFields(
      cls, pid, category, category_name, Attribute_1,Attribute_2,Attribute_3,
    ...
    fields = [search.TextField(name=cls.PID, value=pid),
              ...
              search.TextField(name=cls.ATTRIBUTE_1, value=Attribute_1),
              search.TextField(name=cls.ATTRIBUTE_2, value=Attribute_2),
              search.TextField(name=cls.ATTRIBUTE_3, value=Attribute_3),
              search.TextField(name=cls.ATTRIBUTE_4, value=Attribute_4),
              search.TextField(name=cls.ATTRIBUTE_5, value=Attribute_5),
              search.TextField(name=cls.ATTRIBUTE_6, value=Attribute_6),
              search.TextField(name=cls.ATTRIBUTE_7, value=Attribute_7),
              search.TextField(name=cls.ATTRIBUTE_8, value=Attribute_8),
              search.TextField(name=cls.ATTRIBUTE_9, value=Attribute_9),
              search.TextField(name=cls.ATTRIBUTE_10, value=Attribute_10),
              search.TextField(name=cls.COMPANY, value=Company),
  ...
  @classmethod
  def _buildProductFields(cls, pid=None, category=None, 
       category_name=None,Attribute_1=None,Attribute_2=None,Attribute_3=None,
      Attribute_4=None,Attribute_5=None,Attribute_6=None,Attribute_7=None,Attribute_8=None,
      Attribute_9=None,Attribute_10=None,Company=None,  **params):
    ...
    fields = cls._buildCoreProductFields(
        pid,  category, category_name,Attribute_1,Attribute_2,Attribute_3,
      Attribute_4,Attribute_5,Attribute_6,Attribute_7,Attribute_8,Attribute_9,Attribute_10,Company)
